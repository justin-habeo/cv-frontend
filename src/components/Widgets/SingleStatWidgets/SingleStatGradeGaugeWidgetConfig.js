// src/components/Widgets/SingleStatWidgets/SingleStatGradeGaugeWidgetConfig.js
...
function SingleStatGradeGaugeWidgetConfig({ widget, index, handleWidgetChange, selectedSite }) {
...
export default SingleStatGradeGaugeWidgetConfig;
