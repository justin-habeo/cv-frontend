...
function NDVIImageryWidgetConfig({ widget, index, handleWidgetChange, sitePolygons, handlePolygonIdChange }) {
  const handleSliderChange = (event, newValue) => {
    handleWidgetChange(index, 'config.ndviThreshold', newValue);
  };
...
export default NDVIImageryWidgetConfig;
